    ...
    <section className="min-h-screen flex flex-col justify-center relative w-full pt-20 overflow-hidden">
      ...
      <div className="space-y-8 w-full max-w-7xl mx-auto px-6 md:px-12 z-10 relative mt-12 pb-20">
        ...
        <div className="pt-6 flex flex-wrap gap-4 md:gap-6 items-center">
          <ContactButton label="Organiser un entretien" className="max-md:px-3 cursor-pointer" />
          <a 
            href="/Portfolio/cv-thierry-thiesson.pdf" 
            download="CV-Thierry-Thiesson-Email-Architect.pdf"
            className="bg-white/5 border border-white/10 hover:bg-white/10 text-white px-8 py-4 max-md:px-3 rounded-full font-bold transition-all duration-300 text-lg backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:border-white/30 flex items-center gap-2 cursor-pointer"
          >
          ...
          <a 
            ...
            className="flex items-center gap-2 bg-[#0077b5]/10 border border-[#0077b5]/30 hover:bg-[#0077b5]/20 text-white px-6 py-4 max-md:px-3 rounded-full font-bold transition-all duration-300 text-lg backdrop-blur-md hover:border-[#0077b5]/60 hover:shadow-[0_0_15px_rgba(0,119,181,0.4)] cursor-pointer"
          >
